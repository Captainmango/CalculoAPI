...
ALTER TABLE transaction_categories ADD CONSTRAINT fk4w5cqbyyhe713v88k32809a5i FOREIGN KEY (transaction_id) REFERENCES transactions(id);
ALTER TABLE transaction_categories ADD CONSTRAINT fkl8nhemttklbafivosqgyv35rl FOREIGN KEY (category_id) REFERENCES categories(id);
