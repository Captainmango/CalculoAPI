package com.edward.calculoapi.security;

import com.edward.calculoapi.security.jwt.AuthEntryPointJwt;
import com.edward.calculoapi.security.jwt.AuthTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .authorizeRequests().antMatchers("/api/v1/auth/**", "/actuator/**").permitAll()
